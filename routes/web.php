...
Route::prefix('admin')
    ...
    ->group(function () {
        Route::get('dashboard', [AdminDashboardController::class, 'getData'])->name('admin.dashboard');
        Route::put('users/{id}/usertype', [UserController::class, 'updateUsertype'])->name('users.updateUsertype');
...
Route::prefix('service-provider')
    ...
    ->group(function () {
        Route::get('dashboard', [ServiceProviderDashboardController::class, 'index'])->name('service-provider.dashboard');
